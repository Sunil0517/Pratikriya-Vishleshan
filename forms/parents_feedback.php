...
<body>
  ...
  <div>
	...
	<!-- Create Form -->
	<form id="form" action="parents_insert.php" method="post">
    ...
    <div class="form-control">
			<label class="question">
        2. How do you rate the infrastructural facilities provided by the institute?	
			</label>
			<div class = "radio_">
    ...
    <div class="form-control">
			<label class="question">
				3. Are you happy with the curricular (Add-on Courses/Seminar/Guest Expert Lectures) & Extra-Curricular Activities organized by the Institute?
			</label>
			<div class="radio_">
    ...
    <div class="form-control last_question">
			<label class="question">
				6. Does your ward/Institute regularly inform you about his/her performance?
			</label>
			<div class="radio_">
